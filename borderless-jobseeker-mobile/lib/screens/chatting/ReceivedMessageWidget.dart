...
class _ReceivedMessageWidgetState extends State<ReceivedMessageWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    // DateTime dt = DateTime.parse(message['created_at']);
    // message['created_at'] = f.format(dt);
            ...
            if (message['message_type'] == 'file' &&
              ...
              Transform(
                  transform: Matrix4.translationValues(
                      ...
                      SizeConfig.blockSizeHorizontal * 0.9.h,
                      0.0),
        ...
        Row(
          children: [
            Padding(
              ...
              child: Text(
                xdate(message['created_at'], this.myTimeZone),
                style: TextStyle(
                  fontSize: 10,
